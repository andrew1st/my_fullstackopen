...
const App = () => {
  ...
  return (
    <div>
      ...
      <Statistics good={good} neutral={neutral} bad={bad} all={good + bad + neutral} average={((good-bad)/(good + bad + neutral)).toFixed(1)} positive={(good / (good + bad + neutral) * 100).toFixed(1) + "%"} />
    </div>
  )
}
